...
import Register_New_Patient, Patient_Search_Results
...
class Search(QWidget):
    ...
    def btn_search_clicked(self):
        if self.txt_name.text() =="" or self.txt_sname.text() == "" or self.txt_post.text() =="" or self.txt_mob.text() == "":
            ...
            if not exists:
                ...
                self.new = Patient_Search_Results.Search_Res(pat, descr, self.user_nam)
                self.new.show()
                self.txt_name.clear()
                self.txt_sname.clear()
                self.txt_post.clear()
    ...
    def btn_Reg_clicked(self):
        ...
        self.dialogs = Register_New_Patient.Reg(self.user_nam)
        self.dialogs.show()
