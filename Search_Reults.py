...
class Search_Res(QWidget):
    ...
    def initUI(self, a):
        ...
        grid_layout.addWidget(self.btn_Clr, 3, 0, 1, 2, Qt.AlignJustify)
        ...
        grid_layout.addWidget(self.btn_Back, 4, 0, 1, 2, Qt.AlignJustify)

        # ===============================
        self.empty = QLabel('')
        self.empty.setFixedHeight(70)
        grid_layout.addWidget(self.empty, 5, 0)
        ...
        grid_layout.addWidget(self.lbl_ariston, 6, 0, 1, 2)
