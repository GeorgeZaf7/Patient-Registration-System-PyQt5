...
from PyQt5.QtWidgets import QWidget, QGridLayout, QDesktopWidget, QLabel, QFrame, QCalendarWidget, \
    QPushButton, QMessageBox
import Show_Dated_Medical_Records
        ...
        try:
            ...
            if search_date == check_date:
                ...
                if not columns:
                    ...
                    self.showRes = Show_Dated_Medical_Records.Show_MedRec_Srch_Res(columns)
                    self.showRes.show()
                    #print(len(columns))
